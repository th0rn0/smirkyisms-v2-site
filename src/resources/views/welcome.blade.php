...
<body class="bg-gray-200">
 ...
 --}}
              ...
              <div class="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
                <div class="flex items-center justify-between w-full md:w-auto">
                  <a href="/">
                    ...
                    <h1 class="font-bold text-xl text-indigo-400 hover:text-gray-900">Smirkyisms</h1>
                  </a>
          ...
          <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div class="sm:text-center lg:text-left">
              <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                <span class="block xl:inline text-gray-700">Community Curated</span>
                <span class="block text-indigo-400 xl:inline">Scrap Books</span>
              </h1>
              ...
              <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                <div class="rounded-md shadow">
                  <a href="{{ route('login') }}" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-gray-700 bg-indigo-400 hover:bg-indigo-500 md:py-4 md:text-lg md:px-10">
                    Get started
                  </a>
                </div>
              </div>
    ...
    <div class="py-12 bg-gray-600">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="lg:text-center">
          <p class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-indigo-300 sm:text-4xl">
            Live, Laugh, LOL.
          </p>
    ...
    <div class="py-12 bg-gray-200">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="lg:text-center">
          <h2 class="text-base text-indigo-300 font-semibold tracking-wide uppercase"><a name="about">About</a></h2>
    ...
    <div class="py-12 bg-gray-600">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="lg:text-center">
          <h2 class="text-base text-indigo-300 font-semibold tracking-wide uppercase"><a name="howitworks">How it Works</a></h2>
